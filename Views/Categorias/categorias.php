...
<body>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                <div class="card shadow p-4">
                    ...
                    <!-- FORMULARIO CRUD -->
                    <form method="POST" action="/LENGUAJES_ADMIN/index.php?controller=categoria&action=agregar" enctype="multipart/form-data">

                        <div class="mb-3">
                            <label for="descripcion" class="form-label">Descripción</label>
                            <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="3" placeholder="Descripción de la categoría..."></textarea>
                        </div>
                            ...
                            <?php foreach($categorias as $categoria): ?>
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        <!-- Editar -->
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $categoria['id'] ?>" data-descripcion="<?= htmlspecialchars($categoria['descripcion'], ENT_QUOTES) ?>">Editar</button>

                                        <!-- MODAL DE EDICIÓN -->
                                        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form method="POST" action="/LENGUAJES_ADMIN/index.php?controller=categoria&action=editar">
                                    ...
                                        </div>
                                        ...
                                        <form method="POST" action="/LENGUAJES_ADMIN/index.php?controller=categoria&action=eliminar" onsubmit="return confirm('¿Estás seguro de que deseas inactivar esta categoría?');">
    ...
    <script src="/LENGUAJES_ADMIN/Views/Funciones/categoriasEditarModal.js"></script>
</body>
